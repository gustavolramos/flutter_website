  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          const TextInfo(titleText: 'WELCOME', bodyText: 'My name is Gustavo Ramos, I am a 26-year-old Product Manager and Flutter Developer.', desktopTitleSize: 60, desktopDescriptionSize: 25),
          ...
          const TextInfo(
              titleText: 'TECH',
              bodyText: 'After working closely with Designers and Developers as a Product Manager, I decided to move definitively to tech.', desktopTitleSize: 60, desktopDescriptionSize: 25),
          const SizedBox(height: 20),
          SquareImage(
